    ...
    <div className="photo-wrapper">
      ...
      <div id="bw-wrapper" className="img-filter-wrapper animated-props">
        <div className="wrapped-wrapper">
          ...
          <img id="bw-filter" className="img-filter animated-props" src={personalPhoto} alt="Foto de Federico Reina" />
        </div>
      </div>
      <div id="red-wrapper" className="img-filter-wrapper animated-props">
        <div className="wrapped-wrapper">
          ...
          <img id="red-filter" className="img-filter animated-props" src={personalPhoto} alt="Foto de Federico Reina" />
        </div>
      </div>
      <div id="teal-wrapper" className="img-filter-wrapper animated-props">
        <div className="wrapped-wrapper">
          ...
          <img id="teal-filter" className="img-filter animated-props" src={personalPhoto} alt="Foto de Federico Reina" />
        </div>
      </div>
    </div>
  );
